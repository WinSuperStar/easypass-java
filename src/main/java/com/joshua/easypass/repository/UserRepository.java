...
public interface UserRepository extends JpaRepository<User, Integer> {
    ...
    @Query("SELECT u FROM User u,Role r WHERE u.roleid = r.id and  u.username like %:username% AND u.phone like %:phone% AND r.rolename like %:role% AND u.state like %:state%")
